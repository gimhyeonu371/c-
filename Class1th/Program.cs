namespace Class1th
{
    internal class Program
    {
        ...
        //프로그램의 진입점 역할을 수행하는 함수입니다.
        {
            ...
            #region 자료형
            // 데이터를 저장하기위해 데이터의 형태를 정해주는 것입니다.

            // 자료형은 각각의 자료형마다 크기가 정해져 있으며, 크기는
            // 바이트 단위로 이루어져 있습니다.

            // 자료형의 경우 자료형에 따라 저장할수있는 값의 종류와 범위가 결정됩니다.
            #endregion
            #region 변수
            ...
            //변수의 메모리 공간은 프로그램이 실행될때마다 바뀌며, 여러개의
            //변수가 있을때 서로 고유의 메모리 공간을 가지고 있습니다
            ...
            //메모리 공간으로 해당 메모리에 저장된 값을 참조할수있으며 ,
            //변수를 생성하기위해 메모리 공간의 크기를 지정해주는 자료형을
            //먼저 선언해주어야 합니다.
